...
# Idle-agenda (§6, stage 9.4) — cooldowns live in the generator
# (day/agenda.py), not the runner (agent/queue_runner.py).
IDLE_AGENDA_COOLDOWN_HOURS = _int("IDLE_AGENDA_COOLDOWN_HOURS", 6)
IDLE_AGENDA_QUESTION_COOLDOWN_HOURS = _int("IDLE_AGENDA_QUESTION_COOLDOWN_HOURS", 24)
IDLE_AGENDA_PATTERN_LOOKBACK_DAYS = _int("IDLE_AGENDA_PATTERN_LOOKBACK_DAYS", 56)
IDLE_AGENDA_PATTERN_MIN_COUNT = _int("IDLE_AGENDA_PATTERN_MIN_COUNT", 3)
